            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="view_invoice.php?booking_id=<?php echo $row['booking_id']; ?>" class="btn-view">View Invoice</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
            ...
            <div class="invoice-box">
                ...
                <table class="invoice-table">
                    ...
                    <tr>
                        ...
                        <td class="<?php echo isset($existing_invoice['payment_status']) ? strtolower($existing_invoice['payment_status']) : 'unpaid'; ?>">
